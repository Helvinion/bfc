...
namespace BF
{
    namespace AST
    {
        ...
        void Program::print_amd64(std::ostream& out)
        {
            ...
            out << "bf_input:" << std::endl;
            out << "    push rbp" << std::endl;
            out << "    mov  rbp, rsp" << std::endl;
            out << "    sub  rsp, 0d16" << std::endl;
            out << "    call getchar" << std::endl;
            out << "    cmp  al, 0d255" << std::endl;
            out << "    jne  bf_input_end" << std::endl;
            out << "    inc  al" << std::endl;
            out << "bf_input_end:   " << std::endl;
            out << "    mov  BYTE [rbx], al" << std::endl;
            out << "    leave" << std::endl;
            out << "    ret" << std::endl;
            out << std::endl;
            out << "bf_output:" << std::endl;
            out << "    push rbp" << std::endl;
            out << "    mov  rbp, rsp" << std::endl;
            out << "    sub  rsp, 0d16" << std::endl;
            out << "    cmp  BYTE [rbx], 0" << std::endl;
            out << "    je   bf_output_end" << std::endl;
            out << "    mov  rdi, 0d" << std::endl;
            out << "    mov  dil, BYTE [rbx]" << std::endl;
            out << "    call putchar" << std::endl;
            out << "bf_output_end:   " << std::endl;
            out << "    leave" << std::endl;
            out << "    ret" << std::endl;
            out << std::endl;
            out << "main:" << std::endl;
        ...
        void Program::print_c(std::ostream& out, unsigned int indentation)
        {
            ...
            out << std::endl;
            out << "char bf_input() {unsigned char c = getchar(); return c != 255 ? c : 0;}" << std::endl;
            out << "void bf_output(char c) {if (c != 0) putchar(c);}" << std::endl;
            out << std::endl;
